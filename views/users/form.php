        ...
        <div class="row">
            <div class="col-sm-6">
                    <div class="form-group bmd-form-group">
                        <label for="<?=Html::getInputId($model, 'username');?>" class="bmd-label-floating"><?=Html::activeLabel($model,'username');?></label>
                        <?= $form->field($model, 'username')->textInput(['maxlength' => true])->label(false); ?>
                        <span class="bmd-help"><?=Html::activeHint($model,'username');?></span>
                    </div>
                </div>
            <div class="col-sm-6">
                <div class="form-group bmd-form-group">
            ...
            <div class="col-sm-6">
                <div class="form-group bmd-form-group">
                    <label for="<?=Html::getInputId($model, 'cancion');?>" class="bmd-label-floating"><?=Html::activeLabel($model,'cancion');?></label>
